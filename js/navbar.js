...
function darkModeOn() {
  ...
  footerElement.style.backgroundColor = "rgb(30, 33, 34)";
  footerElement.style.color = "rgb(202, 198, 191)";
...
function darkModeOff() {
  ...
  footerElement.style.backgroundColor = "rgb(244, 244, 244)";
  footerElement.style.color = "#2f2f2f";
